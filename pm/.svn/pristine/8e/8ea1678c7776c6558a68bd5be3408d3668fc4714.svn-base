...
public interface BaseService<T, PK extends Serializable> {
	 ...
	 * @date 2014年3月3日下午5:58:07
	 */
	public <V extends T> V queryById(PK id);
	 ...
	 *            {@link com.orange.framework.dao.BaseDao.selectAll }
	 * @return 结果对象列表
