...
public interface INSCRoleService extends BaseService<INSCRole, String> {

	public List<String> selectRolecodesByRoleids(List<String> rolecodeList) throws ServiceException;
