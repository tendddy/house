...
public class MenuController extends BaseController {
	...
	@ResponseBody
	public List<Map<Object, Object>> meunsManageTreeList(@RequestParam(value = "id", required = false) String id)
	...
	public ModelAndView addMenuParentNodeName(HttpSession session, @ModelAttribute INSCMenu menu)
			throws ControllerException {
		ModelAndView mav = new ModelAndView("system/menusmanager");
	...
	@ResponseBody
	public ModelAndView deleteById(HttpSession session, @RequestParam(value = "id") String id)
			throws ControllerException {
		ModelAndView mav = new ModelAndView("system/menusmanager");
