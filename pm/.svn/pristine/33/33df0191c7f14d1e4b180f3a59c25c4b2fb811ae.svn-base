...
@Repository
public class INSCUserRoleDaoImpl extends BaseDaoImpl<INSCUserRole, String> implements INSCUserRoleDao {

	@Override
	public List<String> selectRoleidByUserid(String userid) throws DaoException {
		return this.sqlSessionTemplate.selectList(this.getSqlName("selectRoleidByUserid"), userid);
	}

	@Override
	public String queryRoleIdsByUid(String id) {
		return this.sqlSessionTemplate.selectOne(this.getSqlName("queryRoleIdsByUid"), id);
	}

	@Override
	public String selectOneByUidAndRid(Map<String, String> map) {
		return this.sqlSessionTemplate.selectOne(this.getSqlName("selectOneByUidAndRid"), map);
	}

	@Override
	public List<INSCUserRole> selectUsersByRoleId(String roleId) {
		return this.sqlSessionTemplate.selectList(this.getSqlName("queryUsersByRoleId"), roleId);
	}

	@Override
	public int deleteByUserIdRoleId(Map<String, String> urId) {
		return this.sqlSessionTemplate.delete(this.getSqlName("deleteByUserIdRoleId"), urId);
	}
