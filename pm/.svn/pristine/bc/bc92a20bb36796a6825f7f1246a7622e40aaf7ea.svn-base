	...
	<div class="container-fluid">
		<form role="form" id="customerform">
			<div class="panel panel-default m-bottom-5">
				<div class="panel-heading padding-5-5">总协议配置</div>
					...
					<div class="col-md-12">
						<form class="form-inline" role="form" id="userform">
							<div class="row">
								...
								<div class="form-group form-inline col-md-5">
									<label class="col-md-5 control-label">总平台代码：</label> <input type="text"
										class="col-md-3 form-control" id="platformNo" name="platformNo">
								</div>
							</div>
						</form>
					</div>
				...
				<div class="panel-body">
					<div id="div1" class="table">
						<div class="col-md-12"  style="width:700px;">
							<table id="protocolConfigPolicy"></table>
						</div>
					</div>
				</div>
