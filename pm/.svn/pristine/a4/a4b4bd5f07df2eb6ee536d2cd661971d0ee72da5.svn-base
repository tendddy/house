...
<body class="bg2">
	<div class="main-cont">
		...
		<div class="body-cont bg1 mar1">
			...
			<dl class="pay-success clearfix">
                 <dt class="f-left"><img src="${staticRoot}/images/payment/sucess.jpg"></dt>
                 <dd  class="f-left">
                      <p class="f5 c5">恭喜您支付成功，支付金额为￥${payfee }</p>
                      <p class="f3">你的订单号为${orderid }</p>
                      <a href="${receiveurl }" target="_self" class="f2 c1">返回首页</a>
                 </dd>
			</dl>
		</div>
	</div>
