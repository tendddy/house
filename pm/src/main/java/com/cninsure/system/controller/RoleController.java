...
public class RoleController extends BaseController {
	...
	public ModelAndView list(HttpSession session, @ModelAttribute INSCRole role) throws ControllerException {
	...
	@ResponseBody
	public Map<String, Object> showrolelist(HttpSession session, @ModelAttribute PagingParams para,
			@ModelAttribute INSCRole role, @ModelAttribute INSCDept dept, @ModelAttribute QueryBean querybean)
					throws ControllerException {
	...
	public ModelAndView rmoveRoleById(String id) {
	...
	public ModelAndView addRole(HttpSession session, @ModelAttribute INSCRole model) {
	...
	public ModelAndView modifyRole(HttpSession session, @ModelAttribute INSCRole model) {
		INSCUser loginUser = (INSCUser) session.getAttribute("insc_user");
		model.setOperator(loginUser.getUsercode().toString());
	...
	@ResponseBody
	public Map<String, String> bindingRoleMenu(HttpSession session, String roleId, String menuIds) {
		Map<String, String> result = inscRoleMenuService.repairRoleMenu(session, roleId, menuIds);
		return result;
	}
	...
	public Map<String, String> benchDeleteByIds(HttpSession session, String roleIds) {
	...
	public Map<String, String> benchDeleteUsersbyRoleid(HttpSession session, String userIds, String roleId) {
		Map<String, String> result = inscRoleService.deleteUsersByRoleId(userIds, roleId);
		return result;
	}
	...
	@ResponseBody
	public Map<String, Object> loadUserList(HttpSession session, @ModelAttribute PagingParams para,
			@ModelAttribute QueryBean querybean, String usercode, String name, String roleId)
					throws ControllerException {
	...
	@ResponseBody
	public Map<String, Object> getUsersByRoleId(HttpSession session, @ModelAttribute PagingParams para,
			@ModelAttribute QueryBean querybean, @RequestParam(required = false) String roleId) {
		Map<String, Object> map = BeanUtils.toMap(querybean, para);
		if (roleId != null) {
			map.put("roleId", roleId);
		} else {
	...
	@ResponseBody
	public Map<String, Object> saveRoleUsers(HttpSession session, String userIds, String roleId) {
