...
@Service
@Transactional
public class INSCRoleMenuServiceImpl extends BaseServiceImpl<INSCRoleMenu, String> implements INSCRoleMenuService {
	@Resource
	...
	@Override
	protected BaseDao<INSCRoleMenu, String> getBaseDao() {
