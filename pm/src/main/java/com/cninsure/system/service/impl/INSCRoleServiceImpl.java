...
@Service
@Transactional
public class INSCRoleServiceImpl extends BaseServiceImpl<INSCRole, String> implements INSCRoleService {
	@Resource
	...
	@Override
	protected BaseDao<INSCRole, String> getBaseDao() {
		return insCRoleDao;
	}

	@Override
	public List<String> selectRolecodesByRoleids(List<String> roleidList) throws ServiceException {
		if (roleidList != null && roleidList.size() > 0 && !roleidList.isEmpty()) {
