...
(function($) {
	...
	$.imgView = function(option){
		...
		var dialog = null;
		if(options.width && options.width!=''){
			dialog = $('<div id="imgView"><div class="modal-dialog" style="width: '+options.width+'"><div class="modal-content" id="modal-content"></div></div></div>');
		}else{
			dialog = $('<div id="imgView"><div class="modal-dialog"><div class="modal-content" id="modal-content"></div></div></div>');
		}
