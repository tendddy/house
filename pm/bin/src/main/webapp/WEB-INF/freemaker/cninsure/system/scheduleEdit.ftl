...
<script type="text/javascript">
	...
	require([ "jquery", "jqform", "bootstrap", "bootstrapdatetimepicker",
			"bootstrapdatetimepickeri18n" ], function($) {
		$(function() {
			initScript();
		});
	});
	...
	<form class="form-horizontal" role="form" id="scheduleForm">
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<#if "${scheEntity.id!''}" != "" > <input type="text"
		...
		<div class="row">
			<div class="form-group">
				...
				<div style="padding-left: 16px;"
					...
					<input class="form-control" type="text" id="starttimeTxt" readonly
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="col-sm-4">
						<select id="periodunit" name="periodunit" style="width: 170px;"
							class="form-control"<#if "${scheEntity.iscron!''}" ==
							"2">disabled="disabled"</#if> >
